...
export function TransactionForm({ onSuccess, initialData }: TransactionFormProps) {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      setExpenseCategories(categories.filter((category: categories) => category.type === "expense"))
      setIncomeCategories(categories.filter((category: categories) => category.type === "income"))
